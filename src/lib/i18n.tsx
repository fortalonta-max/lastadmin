...
const en: Dict = {
  ...
  "admin.utm.title": "UTM Tracking",
  "admin.utm.subtitle": "Which campaign brought the most orders & revenue",
  "admin.utm.stat_tracked": "Tracked orders",
  "admin.utm.stat_revenue": "Tracked revenue",
  "admin.utm.stat_top": "Top campaign",
  "admin.utm.stat_no_utm": "{n} orders without UTM",
  "admin.utm.stat_of_total": "of {total}",
  "admin.utm.table_title": "Campaign breakdown",
  "admin.utm.loading": "Loading…",
  "admin.utm.empty": "No UTM orders in this period. Apply the ZIP and run the SQL migration in Supabase.",
  "admin.utm.col_source": "Source",
  "admin.utm.col_medium": "Medium",
  "admin.utm.col_campaign": "Campaign",
  "admin.utm.col_orders": "Orders",
  "admin.utm.col_revenue": "Revenue",
  "admin.utm.col_avg": "Avg. order",
  "admin.utm.filter_by": "Filter by source:",
  "admin.utm.filter_all": "All ({n})",
  "admin.utm.orders_title": "Tracked orders",
  "admin.utm.col_date": "Date",
  "admin.utm.col_content": "Content",
  "admin.utm.col_total": "Total",
  "admin.utm.link_title": "UTM Link Generator",
  "admin.utm.link_subtitle": "Build a trackable link to paste in your campaigns",
  "admin.utm.link_baseurl": "Your site URL",
  "admin.utm.link_source": "Source (e.g. facebook)",
  "admin.utm.link_medium": "Medium (e.g. paid_ad)",
  "admin.utm.link_campaign": "Campaign name",
  "admin.utm.link_content": "Content (optional)",
  "admin.utm.link_copy": "Copy link",
  "admin.utm.link_copied": "Copied!",
  "admin.utm.link_result": "Generated link — click to copy",
};
...
const ar: Dict = {
  ...
  "admin.utm.title": "تتبع UTM",
  "admin.utm.subtitle": "أي حملة جلبت أكثر الطلبات والإيرادات",
  "admin.utm.stat_tracked": "طلبات متتبعة",
  "admin.utm.stat_revenue": "إيرادات متتبعة",
  "admin.utm.stat_top": "أفضل حملة",
  "admin.utm.stat_no_utm": "{n} طلب بدون UTM",
  "admin.utm.stat_of_total": "من أصل {total}",
  "admin.utm.table_title": "تفصيل الحملات",
  "admin.utm.loading": "جارٍ التحميل…",
  "admin.utm.empty": "لا توجد طلبات بـ UTM في هذه الفترة. تأكد من تطبيق الـ ZIP ورفع ملف SQL على Supabase.",
  "admin.utm.col_source": "المصدر",
  "admin.utm.col_medium": "القناة",
  "admin.utm.col_campaign": "الحملة",
  "admin.utm.col_orders": "الطلبات",
  "admin.utm.col_revenue": "الإيرادات",
  "admin.utm.col_avg": "متوسط الطلب",
  "admin.utm.filter_by": "فلتر حسب المصدر:",
  "admin.utm.filter_all": "الكل ({n})",
  "admin.utm.orders_title": "الطلبات المتتبعة",
  "admin.utm.col_date": "التاريخ",
  "admin.utm.col_content": "المحتوى",
  "admin.utm.col_total": "الإجمالي",
  "admin.utm.link_title": "مولّد روابط UTM",
  "admin.utm.link_subtitle": "أنشئ رابطاً قابلاً للتتبع وضعه في حملاتك",
  "admin.utm.link_baseurl": "رابط موقعك",
  "admin.utm.link_source": "المصدر (مثال: facebook)",
  "admin.utm.link_medium": "القناة (مثال: paid_ad)",
  "admin.utm.link_campaign": "اسم الحملة",
  "admin.utm.link_content": "المحتوى (اختياري)",
  "admin.utm.link_copy": "نسخ الرابط",
  "admin.utm.link_copied": "تم النسخ!",
  "admin.utm.link_result": "الرابط الجاهز — اضغط لنسخه",
};
