      ...
      <header className="mb-6 flex items-center justify-between">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Upload any project — a package, a design, a portfolio piece. Not limited to cookie boxes.
          </p>
        </div>
        <button
          onClick={() =>
            setEditing({ is_active: true, is_best_seller: false, price: 0, sort_order: projects.length + 1 })
          }
